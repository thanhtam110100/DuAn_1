...
public class BoNhoFrame extends javax.swing.JFrame {
    ...
    public BoNhoFrame() {
        ...
        loadData(iBoNhoService.getAll(0));
        loadDataDaXoa();
        _index = -1;
        //this.setDefaultCloseOperation(BoNhoFrame.DISPOSE_ON_CLOSE);

    }

    private void loadData(List<QLBoNho> lst) {
        model = (DefaultTableModel) tblQLBoNho.getModel();
        model.setRowCount(0);
        int count = 1;
        for (QLBoNho h : lst) {
    ...
    private void loadDataDaXoa() {
        ...
        model.setRowCount(0);
        int count = 1;
        List<QLBoNho> lst = iBoNhoService.getAll(1);
        for (QLBoNho h : lst) {
            model.addRow(new Object[]{count++, h.getMa(), h.getTen()});
        }
    }
    ...
    private void initComponents() {
        ...
        tblQLBoNho = new javax.swing.JTable();
        ...
        tblQLBoNho.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblQLBoNho.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblQLBoNhoMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblQLBoNho);
        ...
        jTabbedPane1.addTab("Bộ nhớ", jPanel1);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        List<QLBoNho> lst = iBoNhoService.find(ma);
        if (lst.size() > 0) {
            JOptionPane.showMessageDialog(this, "Mã đã tồn tại!");
            return;
        }
        for (int i = 0; i < iBoNhoService.getAll(0).size(); i++) {
            if (txtTen.getText().equals(iBoNhoService.getAll(0).get(i).getTen())) {
                JOptionPane.showMessageDialog(this, "Tên bộ nhớ không được trùng");
                return;
            }
        }
        QLBoNho c = new QLBoNho(ma, ten);
        if (iBoNhoService.insert(c)) {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        if (_index == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn bộ nhớ muốn sửa");
            return;
        }
        _index = tblQLBoNho.getSelectedRow();
        String id = iBoNhoService.getAll(0).get(_index).getId();
        String ma = txtMa.getText().trim();
        String ten = txtTen.getText().trim();
        if (ma.length() == 0 || ten.length() == 0) {
            JOptionPane.showMessageDialog(this, "Vui lòng điền đủ thông tin các trường");
        ...
        String txtMa = iBoNhoService.getAll(0).get(_index).getMa();
        List<QLBoNho> lst = iBoNhoService.getAll(0);
        ...
        for (int i = 0; i < iBoNhoService.getAll(0).size(); i++) {
            if (txtTen.getText().equals(iBoNhoService.getAll(0).get(i).getTen())
                    && !iBoNhoService.getAll(0).get(_index).getTen().equals(iBoNhoService.getAll(0).get(i).getTen())) {
                JOptionPane.showMessageDialog(this, "Tên bộ nhớ không được trùng");
                return;
            }
        }
        QLBoNho c = new QLBoNho(ma, ten);
        if (iBoNhoService.update(c, id)) {
    ...
    private void tblQLBoNhoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblQLBoNhoMouseClicked
        _index = tblQLBoNho.getSelectedRow();
        txtMa.setText(tblQLBoNho.getValueAt(_index, 1).toString());
        txtTen.setText(tblQLBoNho.getValueAt(_index, 2).toString());
    }//GEN-LAST:event_tblQLBoNhoMouseClicked

    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        _index = tblQLBoNho.getSelectedRow();
        if (_index == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn bộ nhớ muốn xóa");
            return;
        }
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        List<QLBoNho> lst = iBoNhoService.find(timKiem);
        loadData(lst);
        if (lst.size() == 0) {
            JOptionPane.showMessageDialog(this, "Không tìm thấy bộ nhớ " + timKiem);
        }
        clearForm();
    ...
    private void btnKhoiPhucActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKhoiPhucActionPerformed
        ...
        if (_index == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn bộ nhớ muốn khôi phục");
            return;
        }
        ...
        if (xacNhan != JOptionPane.YES_OPTION) {
            ...
            String id = iBoNhoService.getAll(1).get(_index).getId();
            if (iBoNhoService.delete(0, id)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BoNhoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tblQLBoNho;
