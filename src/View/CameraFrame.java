...
public class CameraFrame extends javax.swing.JFrame {
    ...
    public CameraFrame() {
        ...
        loadData(iCameraService.getAll(0));
        loadDataDaXoa();
        _index = -1;
    }

    private void loadData(List<QLCamera> lst) {
        model = (DefaultTableModel) tblQLCamera.getModel();
        model.setRowCount(0);
        int count = 1;
        for (QLCamera c : lst) {
            model.addRow(new Object[]{count++, c.getMa(), c.getTen()});
        }
    }
    ...
    private void loadDataDaXoa() {
        ...
        model.setRowCount(0);
        int count = 1;
        List<QLCamera> lst = iCameraService.getAll(1);
        for (QLCamera c : lst) {
            model.addRow(new Object[]{count++, c.getMa(), c.getTen()});
        }
    }
    ...
    private void initComponents() {
        ...
        tblQLCamera = new javax.swing.JTable();
        ...
        jLabel32.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Photo/all 1.png"))); // NOI18N
        ...
        jLabel32.setBounds(30, 30, 40, 40);
        ...
        tblQLCamera.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblQLCamera.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblQLCameraMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblQLCamera);
        ...
        jLabel2.setText("Tên camera:");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(30, 380, 80, 20);
        jPanel1.add(txtMa);
        ...
        btnExit2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Photo/back (2) (1).png"))); // NOI18N
        ...
        jPanel3.add(btnExit2);
        btnExit2.setBounds(480, 430, 30, 30);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        List<QLCamera> lst = iCameraService.find(ma);
        if (lst.size() > 0) {
            JOptionPane.showMessageDialog(this, "Mã đã tồn tại");
            return;
        }
        for (int i = 0; i < iCameraService.getAll(0).size(); i++) {
            if (txtTen.getText().equals(iCameraService.getAll(0).get(i).getTen())) {
                JOptionPane.showMessageDialog(this, "Tên camera không được trùng");
                return;
            }
        }
        QLCamera c = new QLCamera(ma, ten);
        if (iCameraService.insert(c)) {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        if (_index == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn camera muốn sửa!");
            return;
        }
        _index = tblQLCamera.getSelectedRow();
        String id = iCameraService.getAll(0).get(_index).getId();
        String ma = txtMa.getText().trim();
        String ten = txtTen.getText().trim();
        if (ma.length() == 0 || ten.length() == 0) {
            JOptionPane.showMessageDialog(this, "Vui lòng điền đủ thông tin các trường");
        ...
        String txtMa = iCameraService.getAll(0).get(_index).getMa();
        List<QLCamera> lst = iCameraService.getAll(0);
        ...
        for (int i = 0; i < iCameraService.getAll(0).size(); i++) {
            if (txtTen.getText().equals(iCameraService.getAll(0).get(i).getTen())
                    && !iCameraService.getAll(0).get(_index).getTen().equals(iCameraService.getAll(0).get(i).getTen())) {
                JOptionPane.showMessageDialog(this, "Tên camera không được trùng");
                return;
            }
        }
        QLCamera c = new QLCamera(ma, ten);
        if (iCameraService.update(c, id)) {
    ...
    private void tblQLCameraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblQLCameraMouseClicked
        _index = tblQLCamera.getSelectedRow();
        txtMa.setText(tblQLCamera.getValueAt(_index, 1).toString());
        txtTen.setText(tblQLCamera.getValueAt(_index, 2).toString());
    }//GEN-LAST:event_tblQLCameraMouseClicked

    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        _index = tblQLCamera.getSelectedRow();
        if (_index == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn camera muốn xóa");
            return;
        }
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        List<QLCamera> lst = iCameraService.find(timKiem);
        loadData(lst);
        if (lst.size() == 0) {
            JOptionPane.showMessageDialog(this, "Không tìm thấy camera " + timKiem);
        }
        clearForm();
    ...
    private void btnKhoiPhucActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKhoiPhucActionPerformed
        ...
        if (_index == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn camera muốn khôi phục");
            return;
        }
        ...
        if (xacNhan != JOptionPane.YES_OPTION) {
            ...
            String id = iCameraService.getAll(1).get(_index).getId();
            if (iCameraService.delete(0, id)) {
    ...
    private javax.swing.JTable tblQLCamera;
