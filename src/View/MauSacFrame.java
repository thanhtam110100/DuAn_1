...
public class MauSacFrame extends javax.swing.JFrame {
    ...
    public MauSacFrame() {
        ...
        loadData(iMauSacService.getAll(0));
        loadDataDaXoa();
        _index = -1;
    }

    private void loadData(List<QLMauSac> lst) {
        model = (DefaultTableModel) tblQLMauSac.getModel();
        model.setRowCount(0);
        int count = 1;
        for (QLMauSac ms : lst) {
            model.addRow(new Object[]{count++, ms.getMa(), ms.getTen()});
        }
    }
    ...
    private void loadDataDaXoa() {
        ...
        model.setRowCount(0);
        int count = 1;
        List<QLMauSac> lst = iMauSacService.getAll(1);
        for (QLMauSac ms : lst) {
            model.addRow(new Object[]{count++, ms.getMa(), ms.getTen()});
        }
    }
    ...
    private void initComponents() {
        ...
        tblQLMauSac = new javax.swing.JTable();
        ...
        tblQLMauSac.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblQLMauSac.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblQLMauSacMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblQLMauSac);
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(30, 380, 90, 20);
        jPanel1.add(txtMa);
        ...
        jPanel1.add(btnSua);
        btnSua.setBounds(330, 370, 40, 43);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        List<QLMauSac> lst = iMauSacService.find(ma);
        if (lst.size() > 0) {
            JOptionPane.showMessageDialog(this, "Mã đã tồn tại");
            return;
        }
        for (int i = 0; i < iMauSacService.getAll(0).size(); i++) {
            if (txtTen.getText().equals(iMauSacService.getAll(0).get(i).getTen())) {
                JOptionPane.showMessageDialog(this, "Tên màu sắc không được trùng");
                return;
            }
        }
        QLMauSac ms = new QLMauSac(ma, ten);
        if (iMauSacService.insert(ms)) {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        if (_index == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn màu sắc muốn sửa");
            return;
        }
        _index = tblQLMauSac.getSelectedRow();
        String id = iMauSacService.getAll(0).get(_index).getId();
        String ma = txtMa.getText().trim();
        String ten = txtTen.getText().trim();
        if (ma.length() == 0 || ten.length() == 0) {
            JOptionPane.showMessageDialog(this, "Vui lòng điền đủ thông tin các trường");
        ...
        String txtMa = iMauSacService.getAll(0).get(_index).getMa();
        List<QLMauSac> lst = iMauSacService.getAll(0);
        ...
        for (int i = 0; i < iMauSacService.getAll(0).size(); i++) {
            if (txtTen.getText().equals(iMauSacService.getAll(0).get(i).getTen())
                    && !iMauSacService.getAll(0).get(_index).getTen().equals(iMauSacService.getAll(0).get(i).getTen())) {
                JOptionPane.showMessageDialog(this, "Tên màu sắc không được trùng");
                return;
            }
        }
        QLMauSac c = new QLMauSac(ma, ten);
        if (iMauSacService.update(c, id)) {
    ...
    private void tblQLMauSacMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblQLMauSacMouseClicked
        _index = tblQLMauSac.getSelectedRow();
        txtMa.setText(tblQLMauSac.getValueAt(_index, 1).toString());
        txtTen.setText(tblQLMauSac.getValueAt(_index, 2).toString());
    }//GEN-LAST:event_tblQLMauSacMouseClicked

    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        _index = tblQLMauSac.getSelectedRow();
        if (_index == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn màu sắc muốn xóa");
            return;
        }
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        List<QLMauSac> lst = iMauSacService.find(timKiem);
        loadData(lst);
        if (lst.size() == 0) {
            JOptionPane.showMessageDialog(this, "Không tìm thấy màu sắc " + timKiem);
        }
        clearForm();
    ...
    private void btnKhoiPhucActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKhoiPhucActionPerformed
        ...
        if (_index == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn màu sắc muốn khôi phục");
            return;
        }
        ...
        if (xacNhan != JOptionPane.YES_OPTION) {
            ...
            String id = iMauSacService.getAll(1).get(_index).getId();
            if (iMauSacService.delete(0, id)) {
    ...
    private javax.swing.JTable tblQLMauSac;
